...
class Article extends Model
{
  ...
  public function filterArticles($articles, $main_category) {
   ...
   /** Handle file upload for images andthumbnails .  Keep old file or set
   to default if no images are provided */
   public function uploadImages($request){
     /* Set path and image for main photo. Save image if provided*/
     ...
     /* Set path and image for thumbnail. Sve image if provided*/
