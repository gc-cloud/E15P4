...
class ArticleController extends Controller
{
    ...
    {
      /* Handle gracefully when user is not logged in. Enable markup validation
      when protected routes are Protect for a routing
      failure and enable markup validation */
      if(is_null($author = \Auth::user())) {
        $user = \App\User::first();
          \Session::flash('flash_message','User not logged-in!.');
      }
